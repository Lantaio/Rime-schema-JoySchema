...
## 项目规划
从2023年12月16日开始，此项目将包含classic和nex两个分支。两个分支都是**以提高输入速度为宗旨**，不同之处是：
* classic分支为偏传统输入理念的经典版，在Release中版本号以‘c’开头的便是基于classic分支的发布版。
* nex分支则是更懂你心意的穿越版，在Release中版本号以‘n’开头的便是基于nex分支的发布版。

接下来会将主要精力放在nex分支的开发上，两个分支的功能特点在各自的说明文档中说明，切换分支后查看位于根目录的Readme.md文档。
