...
## 收费情形
你可以*免费*将此项目用于**个人用途**或在**非营利性组织**中使用。但如果你将此项目用于能获取报酬的工作或者商业用途，则需要在3个月免费试用期后向我支付费用。暂定为每台终端收取￥5元，即可获得此项目的永久使用权，并可免费获得所有后续更新的使用权。我会从每笔收费中拿出2元给开发Rime输入法引擎的lotem大神，另外再拿出2元给下面『致谢』中提及的大神。现阶段无法对你进行监管，全凭自觉。另外需要注意的是，此收费不包括任何软件功能及其稳定性方面的承诺或保证，现阶段也无法提供技术支持服务，具体内容见上面『版权许可』部分。
...
![支付宝收款码](JoyDoc/AliPay.png)
![微信收款码](JoyDoc/WePay.png)
...
## 打赏支持
除了商业用途需要购买使用许可之外，如果你觉得此项目很赞，也可以通过上面的付款码给我打赏支持，金额随喜。同样请备注“惊喜输入方案”，我也会按上面『收费情形』所说的比例转账给上面『致谢』中提及的几位大神。谢谢支持，希望此Rime输入方案能带给你愉悦的码字心情！☺
