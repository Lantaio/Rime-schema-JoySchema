...
## 设计理念
* <mark style="background-color: DarkGoldenRod">速度，速度，还是速度！</mark>此Rime输入法方案*并非*追求大而全，而是追求快速的输入体验，因此无论是中文词库还是英文词库都是选用基本词库。另外，此输入法有自造词功能，用户可以在使用过程中形成自己独有的词库，这样就可以有效降低拼音重码和大量无用候选项，减少翻页次数，提高输入效率。你也可以制作和添加固态词库。
